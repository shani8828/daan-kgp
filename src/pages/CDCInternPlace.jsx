...
import CDCInternData from "../components/FresherPlace/CDCInternData";


const CDCInternPlace = () => {
  document.title = "CDC Intern Place | DAAN KGP";
  return (
    <>
      <Helmet>
        <meta
