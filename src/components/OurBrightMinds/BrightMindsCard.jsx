...
const BrightMindsCard = ({ img, name, dept, Year, cg, position, colour }) => {
  return (
    <>
      <div className="relative flex flex-col justify-around items-center p-2 md:p-3 lg:p-4 border border-red-400 bg-gradient-to-tr from-red-300 to-red-100 rounded-lg gap-1 md:gap-2 hover:drop-shadow-lg transition-all duration-300">
        <Helmet>
        ...
        <img
          src={img}
          alt={name}
          className="rounded-full w-[180px] md:w-[230px] lg:w-[250px] shadow-lg border border-red-400"
        />
