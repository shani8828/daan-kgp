...
const EventData = [
  {
    id: 0,
    image: "https://res.cloudinary.com/dcwwptwzt/image/upload/v1747687089/Ravi_Sir_s_Visit_inndze_ly35wq.webp",
  ...
  {
    id: 1,
    image: "https://res.cloudinary.com/dcwwptwzt/image/upload/v1747687201/Farewell_25_ejlura_d992hf.webp",
  ...
  {
    id: 3,
    image: "https://res.cloudinary.com/dcwwptwzt/image/upload/v1747686943/dd_z3ascx.webp",
    ...
    <>
      <div className="dark:bg-gray-900 dark:text-white py-10">
        <section data-aos="fade-up" className="container">
          <h1 className="my-8 border-l-8 border-yellow-300 py-2 pl-2 text-3xl font-bold">
            Our Events
          </h1>
